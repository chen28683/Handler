...
import com.exception.AndroidRuntimeException;
...
public final class MessageQueue {
    ...
    // Barriers are indicated by messages with a null target whose arg1 field
    // carries the token.
...
//            nativePollOnce(mPtr, nextPollTimeoutMillis);
            ...
            synchronized (this) {
                ...
                if (msg != null) {
                    if (now < msg.when) {
                        ...
                        msg.next = null;
                        if (false)
                            System.out.println("MessageQueue" + " Returning message: " + msg);
                        msg.markInUse();
                        return msg;
                    }
                } else {
            ...
            for (int i = 0; i < pendingIdleHandlerCount; i++) {
                ...
                try {
                    ...
                    System.out.println("MessageQueue " + "IdleHandler threw exception");
                }
    ...
    boolean enqueueMessage(Message msg, long when) {
        ...
        synchronized (this) {
            if (mQuitting) {
                ...
                System.out.println("MessageQueue " + e.getMessage());
                return false;
            }
    ...
    // n++;
    // }
    // pw.println(prefix + "(Total messages: " + n + ", idling=" +
    // isIdlingLocked()
    // + ", quitting=" + mQuitting + ")");
    // }
    // }
    void dump(String prefix) {
        synchronized (this) {
            ...
            System.out.println(prefix + "(Total messages: " + n + ", idling=" + isIdlingLocked()
                    + ", quitting=" + mQuitting + ")");
        }
    }
}
