...
public final class Looper {
    ...
    public static void loop() {
        ...
        for (;;) {
            ...
            // logger
            System.out.println(">>>>> Dispatching to " + msg.target + " " +
            ...
            System.out.println(TAG + " Thread identity changed from 0x"
     ...
     * </p>
     * <p class="note">
     * Using this method may be unsafe because some messages may not be
     * delivered before the looper terminates. Consider using
     * {@link #quitSafely} instead to ensure that all pending work is completed
    ...
    /**
     * Posts a synchronization barrier to the Looper's message queue. Message
     * processing occurs as usual until the message queue encounters the
     ...
     * synchronization barrier. This method is used to immediately postpone
     * execution of all subsequently posted synchronous messages until a
     * condition is met that releases the barrier. Asynchronous messages (see
     * {@link Message#isAsynchronous} are exempt from the barrier and continue
     * to be processed as usual. This call must be always matched by a call to
     * {@link #removeSyncBarrier} with the same token to ensure that the message
     * queue resumes normal operation. Otherwise the application will probably
     * hang!
     * 
    ...
    public int postSyncBarrier() {
        return mQueue.enqueueSyncBarrier(System.currentTimeMillis());
    }
    ...
    /**
     * Return whether this looper's thread is currently idle, waiting for new
     * work to do. This is intrinsically racy, since its state can change before
