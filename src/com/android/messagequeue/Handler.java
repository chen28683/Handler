...
public class Handler {
     ...
     * the current thread. If this thread does not have a looper, this handler
     ...
     * messages. If this thread does not have a looper, this handler won't be
     * able to receive messages so an exception is thrown.
     * 
     ...
     * should be asynchronous. Handlers are synchronous by default unless this
     * constructor is used to make one that is strictly asynchronous.
     * Asynchronous messages represent interrupts or events that do not require
     * global ordering with represent to synchronous messages. Asynchronous
     ...
     * interface and set whether the handler should be asynchronous. Handlers
     * are synchronous by default unless this constructor is used to make one
     * that is strictly asynchronous. Asynchronous messages represent interrupts
     * or events that do not require global ordering with represent to
     * synchronous messages. Asynchronous messages are not subject to the
     * synchronization barriers introduced by
     * {@link MessageQueue#enqueueSyncBarrier(long)}.
     * 
     * @param callback The callback interface in which to handle messages, or
     *            null.
     ...
     * handler should be asynchronous. Handlers are synchronous by default
     * unless this constructor is used to make one that is strictly
     * asynchronous. Asynchronous messages represent interrupts or events that
     * do not require global ordering with represent to synchronous messages.
     * Asynchronous messages are not subject to the synchronization barriers
     * introduced by {@link MessageQueue#enqueueSyncBarrier(long)}.
     * 
     * @param looper The looper, must not be null.
     * @param callback The callback interface in which to handle messages, or
     *            null.
